...
### Umami — Web Analytics
Umami is an open-source, self-hosted web analytics platform that collects and displays website traffic data. It's an alternative to third-party web analytics platforms, however with this application you're able to store data within your own infrastructure.
